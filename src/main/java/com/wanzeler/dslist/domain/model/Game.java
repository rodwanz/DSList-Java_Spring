...
public class Game {
		...
		public Game(Long id, String title, Integer year, String genre, String platforms, Double score, String ingUrl,
		...
		public String toString() {
			return "Game [id=" + id + ", title=" + title + ", year=" + year + ", genre=" + genre + ", platform="
					+ platforms + ", score=" + score + ", ingUrl=" + ingUrl + ", shortDescription=" + shortDescription
					+ ", longtDescription=" + longtDescription + "]";
		}
